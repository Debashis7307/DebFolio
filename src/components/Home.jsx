    ...
    >
      ...
      <div className="container mx-auto px-4 py-20 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        >
          ...
          >
            <span className="text-primary text-4xl">"</span>With code, I weave
            dreams into reality,
            <br />
            Creating a world where all is possible.
            <br />
            I'm a developer, with a passion that burns bright,
            <br />
            Building a future that's filled with light.
        ...
        {/* Image - Hidden on screens <= 768px */}
        <motion.div
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8, delay: 0.5 }}
          className="md:w-1/2 relative flex flex-col items-center justify-center max-[769px]:hidden"
        >
